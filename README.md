## Monopoly simmulation
Simulates a 4 player monopoly game played for a set number of turns and counts total visits for each square. Results are then written to a CSV file.
...
Additionally some non-purchasable squares have been ommited from the results.

## Result chart
<img width="594" height="370" alt="image" src="https://github.com/user-attachments/assets/5a51818d-7c2e-42d3-89c5-6b7bc55a076f" />

The x-axis represents monopoly squares squares (starting from Go! being 0). Values on the y-axis represent how many visits a certain square got during the simulation.
